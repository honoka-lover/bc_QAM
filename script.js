...
// 给果果的
honokaMoans = {
    "hot": ["嗷呜~", "嗯~♥~嗯", "好想要💕", "请让小果去吧💕","不要停nya～请，请继续💕","请，请惩罚发情的淫乱小果💕","慢一点喵，人家快忍不住了💕"],
    "medium": ["呜呜💕", "呜咕！", "嗯~💕","喵呜💕","请，请继续💕","小果还想要💕"],
    "light": ["啊呜！", "快、快一点喵💕", "不够呜💕", "继续喵，完全不够喵💕"],
    "low": ["还想要呜", "不要停喵💕", "想要更多呜💕","小果想要奖励喵💕惩罚对小果来说就是最好的奖励喵💕"],
    "orgasm": ["好舒服呜💕", "请、请再让小果高潮一次吧💕💕", "要被玩坏了💕","唔咦！不要一直盯着人家那里看啦，很害羞的呜💕","喂！不要用手机拍照呀，传出去小果就没法见人啦！","请，请记好小果淫乱的样子喵💕或许人家下次就不给看啦！"],
