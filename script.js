...
// 给果果的
honokaMoans = {
    "hot": ["嗷呜~", "嗯~♥~嗯", "好想要", "请让小果去吧♥"],
    "medium": ["呜呜", "呜咕！", "嗯~"],
    "light": ["啊呜", "快、快一点喵", "不够呜", "继续啊，呜呜呜"],
    "low": ["还想要呜", "不要停喵", "想要更多呜"],
    "orgasm": ["好舒服汪♥", "请、请再让小果高潮一次吧", "要被玩坏了"],
...
//狐狸专用
foxMoans = {
    "hot": ["嗷呜", "唔", "坏！",  "嘤~", "痛！", "不许打了！", "嗷！？", "就这？", "错了错了", "请让狐狐去吧~"],
    "medium": ["唔~", "嘤~", "痛啊", "怎么还打"],
    "light": ["呜啊", "嗷？", "不许打了！", "怎么还打", "坏！"],
    "low": ["唔", "坏蛋！", "坏！", "咬你哦"],
    "orgasm": ["嘤~~~", "坏掉了嗷~", "唔~好舒服"],
    "pain": ["嗷呜", "唔", "坏！",  "嘤~", "就这？", "痛！", "不许打了！"]
}
...
aimiliMoans = {
    ...
    "pain": ["唔!", "呜!", "是没吃饭吗?!", "啊QAQ好疼……", "停…停下…求求了…o(╥﹏╥)o", "再打把你推倒!!","呜…错了错了"]
}
